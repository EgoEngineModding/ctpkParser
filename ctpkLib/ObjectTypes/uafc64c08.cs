...
{
    [Section(0xAFC64C08)]
    class uafc64c08_obj : CatalogueObject
    {
        public uafc64c08_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<uafc64c08_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class uafc64c08_obj_map : ObjMap
    {
        ...
        [MappedObject(0x7D9D4F19)][ProtoMember(0x1A)] public uint field_1a;
        [ProtoMember(0x1B)] public uint field_1b;
    }
}