...
{
    [Section(0xFCD83652)]
    class staff_rx_spotter_obj : CatalogueObject
    {
        public staff_rx_spotter_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<staff_rx_spotter_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class staff_rx_spotter_obj_map : ObjMap
    {
