...
{
    [Section(0x744671E9)]
    class discipline_obj : CatalogueObject
    {
        public discipline_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<discipline_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class discipline_obj_map : ObjMap
    {
