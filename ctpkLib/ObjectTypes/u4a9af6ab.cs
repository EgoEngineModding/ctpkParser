...
{
    [Section(0x4A9AF6AB)]
    class u4a9af6ab_obj : CatalogueObject
    {
        public u4a9af6ab_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<u4a9af6ab_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class u4a9af6ab_obj_map : ObjMap
    {
