...
{
    [Section(0x6F0DF564)]
    class ai_driver_levels_obj : CatalogueObject
    {
        public ai_driver_levels_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<ai_driver_levels_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class ai_driver_levels_obj_map : ObjMap
    {
