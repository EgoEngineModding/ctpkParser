...
{
    [Section(0x535271B1)]
    class u535271b1_obj : CatalogueObject
    {
        public u535271b1_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<u535271b1_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class u535271b1_obj_map : ObjMap
    {
        ...
        [MappedObject(0x7245E185)][ProtoMember(0x1F)] public uint field_1f;
    }
}