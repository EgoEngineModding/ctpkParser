...
{
    [Section(0xAD78B1E7)]
    class uad78b1e7_obj : CatalogueObject
    {
        public uad78b1e7_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<uad78b1e7_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class uad78b1e7_obj_map : ObjMap
    {
        [ProtoMember(0x01)] public uint field_1;
        [MappedObject(0x0084B2BF)][ProtoMember(0x02)] public uint field_2;
