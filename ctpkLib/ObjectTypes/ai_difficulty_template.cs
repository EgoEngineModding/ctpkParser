...
{
    [Section(0xB2FC4B5C)]
    class ai_difficulty_template_obj : CatalogueObject
    {
        public ai_difficulty_template_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<ai_difficulty_template_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class ai_difficulty_template_obj_map : ObjMap
    {
