...
{
    [Section(0x684711E5)]
    class staff_engineer_obj : CatalogueObject
    {
        public staff_engineer_obj(CTPKLib lib, UInt32 sectionId, BinaryReader r) : base(lib, sectionId, r)
        {
            _map = Serializer.Deserialize<staff_engineer_obj_map>(new MemoryStream(Data));
        }
    }

    [ProtoContract]
    public class staff_engineer_obj_map : ObjMap
    {
